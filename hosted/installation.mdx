...
<CardGroup cols={2}>
  <Card title="Download for macOS" icon="apple" href="https://github.com/codykociemba/NoLongerEvil-Thermostat/releases/download/v1.0.1/nolongerevil-macos-x64.zip">
    **macOS (Intel x64)**
...
<Note>
  **Apple Silicon (M1/M2/M3) users:** The installer is Intel (x64) only.
  Open it via Rosetta 2: right-click the app → Get Info → check "Open using Rosetta".
  Alternatively, build from source (Node.js 18+).
</Note>
...
<Tabs>
  ...
  <Tab title="macOS">
    1. **Extract the downloaded .zip file**:
       - Double-click `nolongerevil-macos-x64.zip` in Finder
