...
<CardGroup cols={2}>
  ...
  <Card title="Computer" icon="laptop">
    ...
    ⚠️ Windows NOT supported (including WSL)
  </Card>
...
<CardGroup cols={2}>
  <Card title="Download for macOS" icon="apple" href="https://github.com/codykociemba/NoLongerEvil-Thermostat/releases/download/v1.0.0/nolongerevil-installer-mac-x64.zip">
    **macOS (Universal)**
  ...
  <Card title="Download for Linux" icon="linux" href="https://github.com/codykociemba/NoLongerEvil-Thermostat/releases/download/v1.0.0/nolongerevil-installer-linux-x86_64.AppImage">
    **Linux (x64)**
...
<Accordion title="Installer not working? Try manual installation" icon="code">
  ...
  <Tabs>
    <Tab title="Linux">
      ...
      sudo apt-get update
      sudo apt-get install build-essential libusb-1.0-0-dev gcc pkg-config nodejs npm
