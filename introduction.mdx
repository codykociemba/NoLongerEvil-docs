---
title: Introduction
description: 'Take back control of your Nest Thermostat with NoLongerEvil'
---
...
NoLongerEvil is a right-to-repair firmware and cloud replacement for Nest Thermostats that **frees your device from Google's cloud dependency**. By flashing custom firmware, your thermostat will operate independently and connect to NoLongerEvil's platform (or your own self-hosted server), giving you complete control over your device data and settings.
